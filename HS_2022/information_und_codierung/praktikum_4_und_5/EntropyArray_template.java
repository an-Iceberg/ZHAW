    ...
    private void readInputTextFileBytes(File file) {
        ...
        try (BufferedInputStream in = new BufferedInputStream(new FileInputStream(file))) {
            ...
            while ((character = in.read()) != -1) {
                if (!isPrintable(character)) {     // only take printable characters, otherwise continue while loop
                    continue;
                }

                /*
                 * TODO: Anzahl der unterschiedlichen Symbole (fileSymbolCount) nachfuehren
                 *
                 * */
                ...
                /*
                 * TODO: Haeufigkeit des Symbols im Array charCount[] nachfuehren
                 * */



                /*
                 * TODO: Gesamtzahl der Zeichen im File nachfuehren in Variable fileCharactersCount
                 * */
